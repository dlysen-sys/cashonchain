import{dW as k,em as le,cN as c,cP as pe,cz as v,cA as V,cD as f,cE as g,cF as d,cC as l,da as $,cY as H,db as u,cB as me,cU as w,cH as B,d8 as U,ei as fe,e0 as F,cR as K,dQ as A,d0 as M,cK as we,cO as E,dY as z,ef as oe,d9 as be,cJ as ce,en as ge,eo as ye}from"./index-BEP3U47X.js";import{P as D}from"./index-DpXSb07H.js";import{S as ve}from"./SwapController-qrHYEtv0.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
