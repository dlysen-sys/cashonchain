import{dV as k,el as le,cM as c,cO as pe,cy as v,cz as V,cC as f,cD as g,cE as d,cB as l,d9 as $,cX as H,da as u,cA as me,cT as w,cG as B,d7 as U,eh as fe,d$ as F,cQ as K,dP as A,c$ as M,cJ as we,cN as E,dX as z,ee as oe,d8 as be,cI as ce,em as ge,en as ye}from"./index-Bo1gqoV6.js";import{P as D}from"./index-C8-6xdMu.js";import{S as ve}from"./SwapController-BmH9PCqT.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
